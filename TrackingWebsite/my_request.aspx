<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="my_request.aspx.cs" Inherits="TrackingWebsite.my_request" %>
...
<body class="newStyle1">
    ...
    <form id="form1" runat="server">
        <div class="newStyle9">
            <div class="dropdown">
                <asp:Button ID="Button1" runat="server" Width="35px" Text="" CssClass="newStyle17" OnClick="Button1_Click1" BorderStyle="None"/>
                <a href="loginview.aspx">
                    <asp:Image ID="Image10" runat="server" Height="42px" Width="42px" ImageUrl="account2.png" Style="border-radius: 50%" CssClass="newStyle17" />
                </a>
                ...
                <asp:Label ID="Label1" runat="server" Text="" style="font-weight:bold;"></asp:Label>
                    ...
                    <asp:Label ID="Label2" runat="server" Text=""></asp:Label>
                        <br />
                        <br />
                    <asp:Image ID="Image11" runat="server" ImageUrl="contact.png" Height="17px" Width="17px" />
                        Contact:
        ...
        <div class="sidebar">
             <div style="height:74px; background-color:#193F44; padding-left:20px;border-bottom:1px solid gray;">
               <asp:Image ID="Image2" runat="server" Height="56px" ImageUrl="mdtslogo.png" Width="78px" style="top:8px;position:absolute;" />
           </div>
            ...
            <a class="active" href="my_request.aspx">
                <asp:Image ID="Image4" runat="server" Height="20px" ImageUrl="request.png" Width="23px" /><b>
                &nbsp;My Requests</b></a>
        ...
        <asp:Button ID="Button2" runat="server" CssClass="refresh" style="right:2%; height: 58px; width: 150px" Text="Refresh" OnClick="Button2_Click"/>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:fastdeal002_dtsdb1ConnectionString %>" ProviderName="<%$ ConnectionStrings:fastdeal002_dtsdb1ConnectionString.ProviderName %>" SelectCommand="SELECT tracking_no, date, doc_type, sender, address FROM request WHERE user_id=@idnumber">
             <SelectParameters>
            ...
            <asp:Image ID="Image9" runat="server" ImageUrl="empty-box.png" alt="No data to display" Height="576px" visible="false" style="left:35%; right:40%; opacity:0.4;" Width="576px"/>
            ...
            <div id="empty" runat="server" style="text-align: center; position: absolute; top: 45%; width: 300px; right:33%;" visible="false">
                ...
                <br />
                <asp:Label ID="Label4" runat="server" Text="Nothing in Request." Style="color: #666666; top: 56%; left: 727px;"></asp:Label>
            </div>
        ...
        <asp:Image ID="Image1" runat="server" CssClass="newStyle16" ImageUrl="trackbg.png" Height="200px" Width="200px" />

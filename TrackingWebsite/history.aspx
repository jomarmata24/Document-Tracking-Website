<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="history.aspx.cs" Inherits="TrackingWebsite.history" %>
...
<body class="newStyle1">
    <form id="form1" runat="server">
        <div class="newStyle9">
            <div class="dropdown">
                ...
                <a href="loginview.aspx">
                    <asp:Image ID="Image2" runat="server" Height="42px" Width="42px" ImageUrl="account2.png" Style="border-radius: 50%" CssClass="newStyle17" />
                </a>
        ...
        <div class="sidebar">
            ...
            <a class="active" href="history.aspx">
                <asp:Image ID="Image8" runat="server" CssClass="" Height="23px" ImageUrl="history.png" Width="27px" /><b>
                &nbsp;History</b></a>
       ...
       <div class="newStyle14" style="width: 60%; height: auto; left:274px; padding-left:10%; top:17%; padding-right:10%">
        <asp:Button ID="Button2" runat="server" CssClass="refresh" style="right:2%; height: 58px; width: 150px" Text="Refresh" OnClick="Button2_Click"/>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:fastdeal002_dtsdb1ConnectionString %>" ProviderName="<%$ ConnectionStrings:fastdeal002_dtsdb1ConnectionString.ProviderName %>" SelectCommand="SELECT tracking_no, date, doc_type, sender, status, note  FROM history WHERE user_id=@idnumber">
            <SelectParameters>
            ...
            <div id="empty" runat="server" style="text-align: center; position: absolute; top: 45%; width: 300px; right:33%;" visible="false">
                ...
                <br />
                <asp:Label ID="Label4" runat="server" Text="Nothing in History." Style="color: #666666; top: 56%; left: 727px;"></asp:Label>
            </div>
        ...
        <asp:Image ID="Image11" runat="server" CssClass="newStyle16" ImageUrl="trackbg.png" Height="200px" Width="200px" />

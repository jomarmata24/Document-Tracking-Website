<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="received.aspx.cs" Inherits="TrackingWebsite.received" %>
    ...
    <form id="form1" runat="server">
        <div class="newStyle9">
         ...
         <div class="sidebar">
            ...
            <a class="active" href="received.aspx">
                <asp:Image ID="Image5" runat="server" CssClass="auto-style2" Height="19px" ImageUrl="received.png" Width="23px" /><b>
                &nbsp;Received by                                         Admin</b></a>         
       ...
       <div class="newStyle14" style="width: 60%; height: auto; left:274px; padding-left:10%; top:17%; padding-right:10%">
        <asp:Button ID="Button2" runat="server" CssClass="refresh" style="right:2%; height: 58px; width: 150px" Text="Refresh" OnClick="Button2_Click"/>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:fastdeal002_dtsdb1ConnectionString %>" ProviderName="<%$ ConnectionStrings:fastdeal002_dtsdb1ConnectionString.ProviderName %>" SelectCommand="SELECT tracking_no, date, doc_type, sender, status, note FROM received WHERE user_id=@idnumber">
                <SelectParameters>
            ...
            <div id="empty" runat="server" style="text-align: center; position: absolute; top: 45%; width: 300px; right:33%;" visible="false">
                ...
                <br />
                <asp:Label ID="Label4" runat="server" Text="Nothing in Received." Style="color: #666666; top: 56%; left: 727px;"></asp:Label>
            </div>

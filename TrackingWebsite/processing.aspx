<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="processing.aspx.cs" Inherits="TrackingWebsite.processing" %>
...
<body class="newStyle1">
    <form id="form1" runat="server">
         ...
         <div class="sidebar">
            ...
            <a class="active" href="processing.aspx">
                <asp:Image ID="Image6" runat="server" Height="18px" ImageUrl="processing.png" Width="23px" /><b>
                &nbsp;Processing</b></a>
        ...
        <asp:Button ID="Button2" runat="server" CssClass="refresh" style="right:2%; height: 58px; width: 150px" Text="Refresh" OnClick="Button2_Click"/>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:fastdeal002_dtsdb1ConnectionString %>" ProviderName="<%$ ConnectionStrings:fastdeal002_dtsdb1ConnectionString.ProviderName %>" SelectCommand="SELECT tracking_no, date, doc_type, sender FROM processing WHERE user_id=@idnumber">
                <SelectParameters>
            ...
            <div id="empty" runat="server" style="text-align: center; position: absolute; top: 45%; width: 300px; right:33%;" visible="false">
                ...
                <br />
                <asp:Label ID="Label4" runat="server" Text="Nothing in Process." Style="color: #666666; top: 56%; left: 727px;"></asp:Label>
            </div>

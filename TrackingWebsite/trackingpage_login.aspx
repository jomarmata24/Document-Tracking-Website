<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="trackingpage_login.aspx.cs" Inherits="TrackingWebsite.trackingpage_login" %>
...
<body>
    <form id="form1" runat="server">
        <div class="newStyle9">
            ...
            <asp:Button ID="Button4" runat="server" CssClass="auto-style4" Text="CLOSE" BorderColor="#333300" BorderStyle="None" OnClick="Button4_Click" />
        </div>
        ...
        <button class="trackanother"><span><a href="track_login.aspx">Track Another</a></span></button>
    </form>
</body>
</html>
